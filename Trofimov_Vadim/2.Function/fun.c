...
int main(){
    int variant;
    double x,res;
    FILE * rs = fopen("/home/home/Code/2.Function/result.txt","w");
    FILE * rf = fopen("/home/home/Code/2.Function/reference.txt","w");
    FILE * ab = fopen("/home/home/Code/2.Function/abs.txt","w");
    FILE * rel = fopen("/home/home/Code/2.Function/relative.txt","w");
    if (rs==NULL|| rf==NULL|| ab==NULL||rel==NULL)
        exit(0);
    for(;;){
